...
public class StringSorter {
    public static void main(String[] args) {
        ...
        TextBuilder.println(text("Enter some text to sort, or type a number to select a random substring of a preset. Type q to quit."));
            ...
            while (true) {
                ...
                try {
                    ...
                    if (choice < 1 || choice > index) {
                        TextBuilder.println(text("Invalid input: expected a number between 1 and ").red(), text(index).red().bold(), text(".").red());
                        TextBuilder.print(text("> ").blue().bold());
                        continue;
                    }
                    ...
                    text = preset.content.substring(substringIndex, substringIndex + substringLength).trim();
